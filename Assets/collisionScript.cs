...
public class collisionScript : MonoBehaviour {
  ...
  void OnTriggerEnter (Collider col)
  {
    ...
    if (GameObject.FindGameObjectsWithTag("Player").Length == 0){
      ...
      GameObject enemy4 = Instantiate(Resources.Load("enemy3", typeof(GameObject))) as GameObject;
      GameObject enemy5 = Instantiate(Resources.Load("enemy3", typeof(GameObject))) as GameObject;
      GameObject enemy6 = Instantiate(Resources.Load("enemy3", typeof(GameObject))) as GameObject;
